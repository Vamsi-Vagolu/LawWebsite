...
export default function MaintenancePage({ message, estimatedEndTime }: MaintenancePageProps) {
  useEffect(() => {
    // Full-screen maintenance mode styling
  ...
  useEffect(() => {
    // Listen for maintenance being disabled while on maintenance page
    ...
    // Check every 2 seconds while on maintenance page
    const interval = setInterval(checkIfDisabled, 2000);
  ...
  return (
    <>
      {/* Fixed inset covers entire viewport */}
      <div className="fixed inset-0 bg-gradient-to-br from-slate-50 to-gray-100 z-50 flex items-center justify-center px-4">
        <div className="text-center max-w-2xl mx-auto">
          ...
          {/* Orbital Rings System with Central Spinning Gear */}
          <div className="flex justify-center items-center mb-8">
            <div className="relative w-24 h-24 animate-fade-in-slow">
              
              {/* Orbital Ring 1 - Outermost */}
              <div className="absolute inset-0 w-24 h-24 border border-amber-300/30 rounded-full animate-spin-slow">
              ...
              <div className="absolute top-2 left-2 w-20 h-20 border border-amber-400/40 rounded-full animate-spin-reverse">
              ...
              <div className="absolute top-4 left-4 w-16 h-16 border border-amber-500/50 rounded-full animate-spin-fast">
